...
<div class="main_wrap">
    ...
    <div class="wall_wrap clearfix">
        ...
        <?php if(!empty($item['comment_list'])): ?><ul class="rep_list">
            <?php $__FOR_START_20062__=0;$__FOR_END_20062__=C('pin_item_cover_comments');for($i=$__FOR_START_20062__;$i < $__FOR_END_20062__;$i+=1){ if(!empty($item['comment_list'][$i])): ?><li class="rep_f">
